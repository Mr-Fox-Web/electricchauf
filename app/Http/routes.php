...
Route::get('/api/v1/customer/{id?}', 'CustomerController@indexbis');


// Registration routes...
Route::get('customer/register', 'CustomerController@');
...
Route::any('/test', array('as' => 'manage', 'uses' => 'CustomerController@index'));
